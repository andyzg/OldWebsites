<?php
// THIS PAGE ASKS BETWEEN MECHANICS, E&M OR WAVES
...
<div id="center">
	...
	<a href="mechanics/mechanics.php">Mechanics</a>
	</div>
	<div class="choice" name='physics'>
	<a href="waves/waves.php">Waves and Optics </a>
	</div>
	<div class="choice" name='physics'>
	<a href="electricity/electricity.php">Electricity and Magnetism</a>
	</div>
	<form>
</div>
